...
// Простыми числами считаются числа, которые делятся ТОЛЬКО на 1 и на себя.
...
int CountSimpleNum (double[] arr)     // Эта функция возвращает количество простых чисел в массиве
{
    int Count = 0;
